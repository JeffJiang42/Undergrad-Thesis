...
vector bundle. A \ib{vector bundle homomorphism} $\varphi : E \to L$ is a bundle
...
\ib{orthonormal frame bundle} $\mathcal{B}_O(M)$, which is a principal $O_n$
bundle.
\end{exmp}
%
\begin{defn}
...
bubdle $\sigma^*\B(M)$ can be thought of as the bundle of orthonormal frames
