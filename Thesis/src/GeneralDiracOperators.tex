...
\]
where $dV_g$ is the Riemmanian volume form of $M$. Under this inner product,
we get a map $d^* : \Omega^k_M \to \Omega^{k-1}_M$ that is the adjoint to the
...
were originally conceived to be square roots of the Laplacian, it's no surpise
...
\[
D = (\varepsilon(e^k) + \iota_e^k)\partial_k = d + d^*
\]
\end{proof}
%
...
%TODO Relation of Dirac Laplacian with the connection Laplacian
The Dirac operator
%
\iffalse
%
