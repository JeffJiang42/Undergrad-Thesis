...
the expression
\[
\kappa = -\sum_{i, j}\langle R_{e_i, e_j}(e_i), e_j \rangle
\]
\end{thm}
%
\begin{proof} %TODO
...
&= \frac{1}{4} \kappa
\end{align*}
where the last equality comes from the fact that Clifford multiplication between unit
vectors is anticommutative, leaving only the summation over $j = \ell$, and $e_j^2 = 1$.
\end{proof}
%