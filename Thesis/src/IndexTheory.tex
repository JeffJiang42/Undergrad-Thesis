...
$\Cliff(M) \to \Cliff(M)$ that squares to $-\id_{\Cliff(M)}$. This gives
...
the \ib{Kervaire semicharacteristic}. \\
...
underlying manifold, by equating the \ib{analytic index} (what we call the index)
of an elliptic operator with a topological invariant called the \ib{topological index}.
%