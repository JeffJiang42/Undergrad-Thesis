...
\set{\psi : P \to V ~:~ \psi(p \cdot g) = \rho(g)\inv \cdot \psi(p)}
\]
...
\set{\alpha \in \Omega_P^0(V) ~:~ R_g^*\alpha = \alpha} \subset \Omega_P^0(V)
\]
...
\set{\alpha \in \Omega_P^k(V) ~:~ R_g^*\alpha = \alpha ~~\forall g \in G,~
