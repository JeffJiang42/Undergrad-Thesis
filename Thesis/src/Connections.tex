...
$\rho : GL_n\R \to GL(V)$ let $E \to M$ denote the associated bundle, and
...
$\partial_i\psi$, so the tensor product $\partial_i\tilde{\psi} \otimes e^i$
then defines a section of $E \otimes T^*M$.
\end{proof}
%
